...
#                      stock_code=stock['code'], limit=20)
        process.crawl(FinanceVietstock, group=stock['group'],
                      start_url="https://finance.vietstock.vn/{0}/tin-tuc-su-kien.htm".format(stock['code']),
